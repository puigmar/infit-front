    ...
    <Fragment>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <div className="form-check button-check">
          ...
          <label htmlFor="objective1" className="form-check-label"><span className="icon-perder-peso"></span> Perder Peso</label>
        </div>
        <div className="form-check button-check">
          ...
          <label htmlFor="objective2" className="form-check-label"><span className="icon-fuerza"></span> Ganar Músculo</label>
        </div>
        <div className="form-check button-check">
          ...
          <label htmlFor="objective3" className="form-check-label"><span className="icon-mantenerse"></span> Mantenerse</label>
        </div>
